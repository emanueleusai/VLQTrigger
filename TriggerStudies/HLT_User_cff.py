# /dev/CMSSW_7_2_0/GRun/V14 (CMSSW_7_2_0_pre8)

import FWCore.ParameterSet.Config as cms


HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_7_2_0/GRun/V14')
)
...
HLTSchedule = cms.Schedule( *(HLTriggerFirstPath, HLTriggerFinalPath ))
...
# /users/drankin/TrimJets/DiJet/V21 (CMSSW_7_2_0_pre6_HLT1)

import FWCore.ParameterSet.Config as cms


HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/drankin/TrimJets/DiJet/V21')
)
...
hltL1sL1HTT175 = cms.EDFilter( "HLTLevel1GTSeed",
...
hltPreAK8DiPFJetTrimModMass750Deta1p5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
hltDiCentralPFJet30 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
...
hltFatDiPFJetMass750DR1p1Deta1p5 = cms.EDFilter( "HLTFatPFJetMassFilter",
    saveTags = cms.bool( True ),
...
hltPreFatDiPFJetMass850DR1p1Deta1p5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltFatDiPFJetMass850DR1p1Deta1p5 = cms.EDFilter( "HLTFatPFJetMassFilter",
    saveTags = cms.bool( True ),
    inputJetTag = cms.InputTag( "hltAK4PFJetsCorrected" ),
    minMass = cms.double( 850.0 ),
    maxDeltaEta = cms.double( 1.5 ),
    minJetPt = cms.double( 30.0 ),
    triggerType = cms.int32( 85 ),
    maxJetEta = cms.double( 3.0 ),
...
hltPreAK8DiPFJet300200TrimModDiMass30 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
hltAK8SingleCaloJet240 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
...
hltAK8PFJetsCorrectedMatchedToCaloJets240 = cms.EDProducer( "PFJetsMatchedToFilteredCaloJetsProducer",
...
hltAK8DiPFJet200TrimModMass30 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
...
hltAK8SinglePFJet300TrimModMass30 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
...
hltPreAK8DiPFJet300250TrimModDiMass30 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltAK8DiPFJet250TrimModMass30 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
...
hltPreAK8DiPFJet280250TrimModDiMass30 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltAK8SinglePFJet280TrimModMass30 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
...
hltPreAK8DiPFJet320280TrimModMass30 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltAK8DiPFJet280TrimMod = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 280.0 ),
    MinN = cms.int32( 2 ),
    MaxEta = cms.double( 5.0 ),
...
hltAK8SinglePFJet320TrimModMass30 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
...
hltPreAK8DiPFJetAve300TrimModMass30 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltDiPFJetAve300TrimMod = cms.EDFilter( "HLTDiPFJetAveFilter",
    saveTags = cms.bool( True ),
    inputJetTag = cms.InputTag( "hltAK8TrimModJets" ),
    minPtAve = cms.double( 300.0 ),
    minPtJet3 = cms.double( 99999.0 ),
    triggerType = cms.int32( 85 ),
    minDphi = cms.double( -1.0 )
)
hltPreAK8DiPFJet300200TrimModMass30 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltAK8DiPFJet200TrimMod = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 200.0 ),
    MinN = cms.int32( 2 ),
    MaxEta = cms.double( 5.0 ),
...
hltPreAK8DiPFJet300250TrimModMass30 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltAK8DiPFJet250TrimMod = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 250.0 ),
    MinN = cms.int32( 2 ),
    MaxEta = cms.double( 5.0 ),
...
hltPreAK8DiPFJet280250TrimModMass30 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltPreAK8DiPFJet300200TrimModMass30InvMass400 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltAK8DiPFJet200TrimModMinv400 = cms.EDFilter( "HLT2PFJetPFJet",
    saveTags = cms.bool( True ),
    MinMinv = cms.double( 400.0 ),
    originTag2 = cms.VInputTag( 'hltAK8TrimModJets' ),
    MinDelR = cms.double( -1.0 ),
    MinPt = cms.double( -1.0 ),
    MinN = cms.int32( 1 ),
    originTag1 = cms.VInputTag( 'hltAK8TrimModJets' ),
    triggerType1 = cms.int32( 85 ),
    triggerType2 = cms.int32( 85 ),
    MaxMinv = cms.double( 999999.0 ),
    MinDeta = cms.double( -1.0 ),
    MaxDelR = cms.double( 999999.0 ),
    inputTag1 = cms.InputTag( "hltAK8DiPFJet200TrimMod" ),
    inputTag2 = cms.InputTag( "hltAK8DiPFJet200TrimMod" ),
    MaxDphi = cms.double( 999999.0 ),
    MaxDeta = cms.double( 999999.0 ),
    MaxPt = cms.double( 999999.0 ),
    MinDphi = cms.double( -1.0 )
)
hltPreHLTAK8DiPFJet300250TrimModMass30InvMass400 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltAK8DiPFJet250TrimModMinv400 = cms.EDFilter( "HLT2PFJetPFJet",
    saveTags = cms.bool( True ),
    MinMinv = cms.double( 400.0 ),
    originTag2 = cms.VInputTag( 'hltAK8TrimModJets' ),
    MinDelR = cms.double( -1.0 ),
    ...
    MinDeta = cms.double( -1.0 ),
    MaxDelR = cms.double( 999999.0 ),
    inputTag1 = cms.InputTag( "hltAK8DiPFJet250TrimMod" ),
    inputTag2 = cms.InputTag( "hltAK8DiPFJet250TrimMod" ),
    MaxDphi = cms.double( 999999.0 ),
    MaxDeta = cms.double( 999999.0 ),
    MaxPt = cms.double( 999999.0 ),
    MinDphi = cms.double( -1.0 )
)
hltPreHLTAK8DiPFJet280250TrimModMass30InvMass400 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltPreAK8DiPFJet300200TrimModDphi1p5Mass30 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltAK8DiPFJet200TrimModDphi1p5 = cms.EDFilter( "HLT2PFJetPFJet",
    saveTags = cms.bool( True ),
    ...
    MaxDeta = cms.double( 999999.0 ),
    MaxPt = cms.double( 999999.0 ),
    MinDphi = cms.double( 1.5 )
)
hltPreAK8DiPFJet300250TrimModDphi1p5Mass30 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltAK8DiPFJet250TrimModDphi1p5 = cms.EDFilter( "HLT2PFJetPFJet",
    saveTags = cms.bool( True ),
    MinMinv = cms.double( -1.0 ),
    originTag2 = cms.VInputTag( 'hltAK8TrimModJets' ),
    MinDelR = cms.double( -1.0 ),
...
hltPreAK8DiPFJet280250TrimModDphi1p5Mass30 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltPreAK8PFJet280TrimModMass30AK4PFJet250 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltAK4DiPFJet250 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 250.0 ),
    MinN = cms.int32( 2 ),
    MaxEta = cms.double( 5.0 ),
...
hltPreAK8PFJet300TrimModMass30AK4PFJet200 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltAK4DiPFJet200 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 200.0 ),
    MinN = cms.int32( 2 ),
    MaxEta = cms.double( 5.0 ),
...
hltPreAK8PFJet300TrimModMass30AK4PFJet250 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
hltPreAK8PFHT850TrimR0p1PT0p03Mass50 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltAK8HtMht = cms.EDProducer( "HLTHtMhtProducer",
    usePt = cms.bool( False ),
    minPtJetHt = cms.double( 40.0 ),
    maxEtaJetMht = cms.double( 5.0 ),
    minNJetMht = cms.int32( 0 ),
...
hltAK8Ht750 = cms.EDFilter( "HLTHtMhtFilter",
    saveTags = cms.bool( False ),
...
hltAK8PFHT = cms.EDProducer( "HLTHtMhtProducer",
    usePt = cms.bool( True ),
    minPtJetHt = cms.double( 40.0 ),
    maxEtaJetMht = cms.double( 999.0 ),
    minNJetMht = cms.int32( 0 ),
...
hltAK8PFJetsTrimR0p1PT0p03 = cms.EDProducer( "FastjetJetProducer",
    Active_Area_Repeats = cms.int32( 5 ),
    doAreaFastjet = cms.bool( False ),
    voronoiRfact = cms.double( -9.0 ),
    maxBadHcalCells = cms.uint32( 9999999 ),
...
hlt1AK8PFJetsTrimR0p1PT0p03Mass50 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( False ),
...
hltAK8PFHT850 = cms.EDFilter( "HLTHtMhtFilter",
    saveTags = cms.bool( True ),
...
hltL1sL1DoubleJetC100 = cms.EDFilter( "HLTLevel1GTSeed",
...
hltPreAK8DiPFJet300200TrimModMass30DoubleJetC100 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltPreAK8DiPFJet300250TrimModMass30DoubleJetC100 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltPreAK8DiPFJet280250TrimModMass30DoubleJetC100 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltPreAK8DiPFJet300200TrimModMass30BTagCSVLoose0p3 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
hltBLifetimeL3FilterCSVLoose0p3 = cms.EDFilter( "HLTCaloJetTag",
    saveTags = cms.bool( True ),
    MinJets = cms.int32( 1 ),
...
hltPreAK8DiPFJet300250TrimModMass30BTagCSVLoose0p3 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltPreAK8DiPFJet280250TrimModMass30BTagCSVLoose0p3 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltPreAK8DiPFJet300200TrimModMass30BTagCSVLoose0p5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltBLifetimeL3FilterCSVLoose0p5 = cms.EDFilter( "HLTCaloJetTag",
    saveTags = cms.bool( True ),
    MinJets = cms.int32( 1 ),
    JetTags = cms.InputTag( "hltL3CombinedSecondaryVertexBJetTags" ),
    TriggerType = cms.int32( 86 ),
...
hltPreAK8DiPFJet300250TrimModMass30BTagCSVLoose0p5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltPreAK8DiPFJet280250TrimModMass30BTagCSVLoose0p5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltPreAK8DiPFJet300200TrimModMass30BTagCSVMed0p7 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltBLifetimeL3FilterCSVMed0p7 = cms.EDFilter( "HLTCaloJetTag",
    saveTags = cms.bool( True ),
    MinJets = cms.int32( 1 ),
    JetTags = cms.InputTag( "hltL3CombinedSecondaryVertexBJetTags" ),
    TriggerType = cms.int32( 86 ),
...
hltPreAK8DiPFJet300250TrimModMass30BTagCSVMed0p7 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
hltPreAK8DiPFJet280250TrimModMass30BTagCSVMed0p7 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
HLT_PFHT900_v1 = cms.Path( HLTBeginSequence + hltL1sL1HTT175 + hltPrePFHT900 + HLTAK4CaloJetsSequence + hltHtMht + hltHt700 + HLTAK4PFJetsSequence + hltPFHT + hltPFHT900 + HLTEndSequence )
HLT_FatDiPFJetMass750_DR1p1_Deta1p5_v1 = cms.Path( HLTBeginSequence + hltL1sL1HTT175 + hltPreAK8DiPFJetTrimModMass750Deta1p5 + HLTAK4CaloJetsSequence + hltHtMht + hltHt550 + HLTAK4PFJetsSequence + hltDiCentralPFJet30 + hltFatDiPFJetMass750DR1p1Deta1p5 + HLTEndSequence )
HLT_FatDiPFJetMass850_DR1p1_Deta1p5_v1 = cms.Path( HLTBeginSequence + hltL1sL1HTT175 + hltPreFatDiPFJetMass850DR1p1Deta1p5 + HLTAK4CaloJetsSequence + hltHtMht + hltHt550 + HLTAK4PFJetsSequence + hltDiCentralPFJet30 + hltFatDiPFJetMass850DR1p1Deta1p5 + HLTEndSequence )
HLT_AK8DiPFJet300_200TrimMod_DiMass30_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet300200TrimModDiMass30 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet200TrimModMass30 + hltAK8SinglePFJet300TrimModMass30 + HLTEndSequence )
HLT_AK8DiPFJet300_250TrimMod_DiMass30_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet300250TrimModDiMass30 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet250TrimModMass30 + hltAK8SinglePFJet300TrimModMass30 + HLTEndSequence )
HLT_AK8DiPFJet280_250TrimMod_DiMass30_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet280250TrimModDiMass30 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet250TrimModMass30 + hltAK8SinglePFJet280TrimModMass30 + HLTEndSequence )
HLT_AK8DiPFJet320_280TrimMod_Mass30_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet320280TrimModMass30 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet280TrimMod + hltAK8SinglePFJet320TrimModMass30 + HLTEndSequence )
HLT_AK8DiPFJetAve300TrimMod_Mass30_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJetAve300TrimModMass30 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8SinglePFJet320TrimModMass30 + hltDiPFJetAve300TrimMod + HLTEndSequence )
HLT_AK8DiPFJet300_200TrimMod_Mass30_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet300200TrimModMass30 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet200TrimMod + hltAK8SinglePFJet300TrimModMass30 + HLTEndSequence )
HLT_AK8DiPFJet300_250TrimMod_Mass30_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet300250TrimModMass30 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet250TrimMod + hltAK8SinglePFJet300TrimModMass30 + HLTEndSequence )
HLT_AK8DiPFJet280_250TrimMod_Mass30_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet280250TrimModMass30 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet250TrimMod + hltAK8SinglePFJet280TrimModMass30 + HLTEndSequence )
HLT_AK8DiPFJet300_200TrimMod_Mass30_InvMass400_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet300200TrimModMass30InvMass400 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet200TrimMod + hltAK8SinglePFJet300TrimModMass30 + hltAK8DiPFJet200TrimModMinv400 + HLTEndSequence )
HLT_AK8DiPFJet300_250TrimMod_Mass30_InvMass400_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreHLTAK8DiPFJet300250TrimModMass30InvMass400 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet250TrimMod + hltAK8SinglePFJet300TrimModMass30 + hltAK8DiPFJet250TrimModMinv400 + HLTEndSequence )
HLT_AK8DiPFJet280_250TrimMod_Mass30_InvMass400_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreHLTAK8DiPFJet280250TrimModMass30InvMass400 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet250TrimMod + hltAK8SinglePFJet280TrimModMass30 + hltAK8DiPFJet250TrimModMinv400 + HLTEndSequence )
HLT_AK8DiPFJet300_200TrimMod_Dphi1p5_Mass30_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet300200TrimModDphi1p5Mass30 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet200TrimMod + hltAK8DiPFJet200TrimModDphi1p5 + hltAK8SinglePFJet300TrimModMass30 + HLTEndSequence )
HLT_AK8DiPFJet300_250TrimMod_Dphi1p5_Mass30_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet300250TrimModDphi1p5Mass30 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet250TrimMod + hltAK8DiPFJet250TrimModDphi1p5 + hltAK8SinglePFJet300TrimModMass30 + HLTEndSequence )
HLT_AK8DiPFJet280_250TrimMod_Dphi1p5_Mass30_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet280250TrimModDphi1p5Mass30 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet250TrimMod + hltAK8DiPFJet250TrimModDphi1p5 + hltAK8SinglePFJet280TrimModMass30 + HLTEndSequence )
HLT_AK8PFJet280TrimMod_Mass30_AK4PFJet250_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8PFJet280TrimModMass30AK4PFJet250 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8SinglePFJet280TrimModMass30 + HLTAK4PFJetsSequence + hltAK4DiPFJet250 + HLTEndSequence )
HLT_AK8PFJet300TrimMod_Mass30_AK4PFJet200_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8PFJet300TrimModMass30AK4PFJet200 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8SinglePFJet300TrimModMass30 + HLTAK4PFJetsSequence + hltAK4DiPFJet200 + HLTEndSequence )
HLT_AK8PFJet300TrimMod_Mass30_AK4PFJet250_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8PFJet300TrimModMass30AK4PFJet250 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8SinglePFJet300TrimModMass30 + HLTAK4PFJetsSequence + hltAK4DiPFJet250 + HLTEndSequence )
...
HLT_AK8PFHT850_TrimR0p1PT0p03Mass50_v1 = cms.Path( HLTBeginSequence + hltL1sL1HTT175 + hltPreAK8PFHT850TrimR0p1PT0p03Mass50 + HLTAK8CaloJetsSequence + hltAK8HtMht + hltAK8Ht750 + HLTAK8PFJetsSequence + hltAK8PFHT + hltAK8PFJetsTrimR0p1PT0p03 + hlt1AK8PFJetsTrimR0p1PT0p03Mass50 + hltAK8PFHT850 + HLTEndSequence )
HLT_AK8DiPFJet300_200TrimMod_Mass30_DoubleJetC100_v1 = cms.Path( HLTBeginSequence + hltL1sL1DoubleJetC100 + hltPreAK8DiPFJet300200TrimModMass30DoubleJetC100 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet200TrimMod + hltAK8SinglePFJet300TrimModMass30 + HLTEndSequence )
HLT_AK8DiPFJet300_250TrimMod_Mass30_DoubleJetC100_v1 = cms.Path( HLTBeginSequence + hltL1sL1DoubleJetC100 + hltPreAK8DiPFJet300250TrimModMass30DoubleJetC100 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet250TrimMod + hltAK8SinglePFJet300TrimModMass30 + HLTEndSequence )
HLT_AK8DiPFJet280_250TrimMod_Mass30_DoubleJetC100_v1 = cms.Path( HLTBeginSequence + hltL1sL1DoubleJetC100 + hltPreAK8DiPFJet280250TrimModMass30DoubleJetC100 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet250TrimMod + hltAK8SinglePFJet280TrimModMass30 + HLTEndSequence )
HLT_AK8DiPFJet300_200TrimMod_Mass30_BTagCSVLoose0p3_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet300200TrimModMass30BTagCSVLoose0p3 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet200TrimMod + hltAK8SinglePFJet300TrimModMass30 + HLTAK4CaloJetsSequence + HLTFastPrimaryVertexSequence + hltFastPVPixelVertexSelector + HLTBtagCSVSequenceL3 + hltBLifetimeL3FilterCSVLoose0p3 + HLTEndSequence )
HLT_AK8DiPFJet300_250TrimMod_Mass30_BTagCSVLoose0p3_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet300250TrimModMass30BTagCSVLoose0p3 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet250TrimMod + hltAK8SinglePFJet300TrimModMass30 + HLTAK4CaloJetsSequence + HLTFastPrimaryVertexSequence + hltFastPVPixelVertexSelector + HLTBtagCSVSequenceL3 + hltBLifetimeL3FilterCSVLoose0p3 + HLTEndSequence )
HLT_AK8DiPFJet280_250TrimMod_Mass30_BTagCSVLoose0p3_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet280250TrimModMass30BTagCSVLoose0p3 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet250TrimMod + hltAK8SinglePFJet280TrimModMass30 + HLTAK4CaloJetsSequence + HLTFastPrimaryVertexSequence + hltFastPVPixelVertexSelector + HLTBtagCSVSequenceL3 + hltBLifetimeL3FilterCSVLoose0p3 + HLTEndSequence )
HLT_AK8DiPFJet300_200TrimMod_Mass30_BTagCSVLoose0p5_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet300200TrimModMass30BTagCSVLoose0p5 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet200TrimMod + hltAK8SinglePFJet300TrimModMass30 + HLTAK4CaloJetsSequence + HLTFastPrimaryVertexSequence + hltFastPVPixelVertexSelector + HLTBtagCSVSequenceL3 + hltBLifetimeL3FilterCSVLoose0p5 + HLTEndSequence )
HLT_AK8DiPFJet300_250TrimMod_Mass30_BTagCSVLoose0p5_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet300250TrimModMass30BTagCSVLoose0p5 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet250TrimMod + hltAK8SinglePFJet300TrimModMass30 + HLTAK4CaloJetsSequence + HLTFastPrimaryVertexSequence + hltFastPVPixelVertexSelector + HLTBtagCSVSequenceL3 + hltBLifetimeL3FilterCSVLoose0p5 + HLTEndSequence )
HLT_AK8DiPFJet280_250TrimMod_Mass30_BTagCSVLoose0p5_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet280250TrimModMass30BTagCSVLoose0p5 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet250TrimMod + hltAK8SinglePFJet280TrimModMass30 + HLTAK4CaloJetsSequence + HLTFastPrimaryVertexSequence + hltFastPVPixelVertexSelector + HLTBtagCSVSequenceL3 + hltBLifetimeL3FilterCSVLoose0p5 + HLTEndSequence )
HLT_AK8DiPFJet300_200TrimMod_Mass30_BTagCSVMed0p7_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet300200TrimModMass30BTagCSVMed0p7 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet200TrimMod + hltAK8SinglePFJet300TrimModMass30 + HLTAK4CaloJetsSequence + HLTFastPrimaryVertexSequence + hltFastPVPixelVertexSelector + HLTBtagCSVSequenceL3 + hltBLifetimeL3FilterCSVMed0p7 + HLTEndSequence )
HLT_AK8DiPFJet300_250TrimMod_Mass30_BTagCSVMed0p7_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet300250TrimModMass30BTagCSVMed0p7 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet250TrimMod + hltAK8SinglePFJet300TrimModMass30 + HLTAK4CaloJetsSequence + HLTFastPrimaryVertexSequence + hltFastPVPixelVertexSelector + HLTBtagCSVSequenceL3 + hltBLifetimeL3FilterCSVMed0p7 + HLTEndSequence )
HLT_AK8DiPFJet280_250TrimMod_Mass30_BTagCSVMed0p7_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleJet176 + hltPreAK8DiPFJet280250TrimModMass30BTagCSVMed0p7 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet240 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets240 + hltAK8TrimModJets + hltAK8DiPFJet250TrimMod + hltAK8SinglePFJet280TrimModMass30 + HLTAK4CaloJetsSequence + HLTFastPrimaryVertexSequence + hltFastPVPixelVertexSelector + HLTBtagCSVSequenceL3 + hltBLifetimeL3FilterCSVMed0p7 + HLTEndSequence )


HLTSchedule = cms.Schedule( *(HLT_PFHT900_v1, HLT_FatDiPFJetMass750_DR1p1_Deta1p5_v1, HLT_FatDiPFJetMass850_DR1p1_Deta1p5_v1, HLT_AK8DiPFJet300_200TrimMod_DiMass30_v1, HLT_AK8DiPFJet300_250TrimMod_DiMass30_v1, HLT_AK8DiPFJet280_250TrimMod_DiMass30_v1, HLT_AK8DiPFJet320_280TrimMod_Mass30_v1, HLT_AK8DiPFJetAve300TrimMod_Mass30_v1, HLT_AK8DiPFJet300_200TrimMod_Mass30_v1, HLT_AK8DiPFJet300_250TrimMod_Mass30_v1, HLT_AK8DiPFJet280_250TrimMod_Mass30_v1, HLT_AK8DiPFJet300_200TrimMod_Mass30_InvMass400_v1, HLT_AK8DiPFJet300_250TrimMod_Mass30_InvMass400_v1, HLT_AK8DiPFJet280_250TrimMod_Mass30_InvMass400_v1, HLT_AK8DiPFJet300_200TrimMod_Dphi1p5_Mass30_v1, HLT_AK8DiPFJet300_250TrimMod_Dphi1p5_Mass30_v1, HLT_AK8DiPFJet280_250TrimMod_Dphi1p5_Mass30_v1, HLT_AK8PFJet280TrimMod_Mass30_AK4PFJet250_v1, HLT_AK8PFJet300TrimMod_Mass30_AK4PFJet200_v1, HLT_AK8PFJet300TrimMod_Mass30_AK4PFJet250_v1, HLT_AK8PFJet360TrimMod_Mass30_v1, HLT_AK8PFHT850_TrimR0p1PT0p03Mass50_v1, HLT_AK8DiPFJet300_200TrimMod_Mass30_DoubleJetC100_v1, HLT_AK8DiPFJet300_250TrimMod_Mass30_DoubleJetC100_v1, HLT_AK8DiPFJet280_250TrimMod_Mass30_DoubleJetC100_v1, HLT_AK8DiPFJet300_200TrimMod_Mass30_BTagCSVLoose0p3_v1, HLT_AK8DiPFJet300_250TrimMod_Mass30_BTagCSVLoose0p3_v1, HLT_AK8DiPFJet280_250TrimMod_Mass30_BTagCSVLoose0p3_v1, HLT_AK8DiPFJet300_200TrimMod_Mass30_BTagCSVLoose0p5_v1, HLT_AK8DiPFJet300_250TrimMod_Mass30_BTagCSVLoose0p5_v1, HLT_AK8DiPFJet280_250TrimMod_Mass30_BTagCSVLoose0p5_v1, HLT_AK8DiPFJet300_200TrimMod_Mass30_BTagCSVMed0p7_v1, HLT_AK8DiPFJet300_250TrimMod_Mass30_BTagCSVMed0p7_v1, HLT_AK8DiPFJet280_250TrimMod_Mass30_BTagCSVMed0p7_v1 ))
